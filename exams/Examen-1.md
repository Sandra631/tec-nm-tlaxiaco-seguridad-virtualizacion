...
Nombre: Sandra Yolotzin Reyes García
...
* ☑️ c) Un proceso de evaluación de la seguridad que simula un ataque real.
...
* ☑️ b) Una técnica de seguridad que utiliza algoritmos criptográficos para verificar la autenticidad e integridad de un archivo.
...
* ☑️ d) Ley de Instituciones de Crédito.

23. ¿Cuál es la función del Código Penal en relación con la seguridad de la información?

* ☑️ a) Establecer los delitos y las sanciones penales por acciones que atentan contra la seguridad de la información.
...
* ☑️ d) Compartir información personal en redes sociales.
...
* ☑️ d) Análisis de la rentabilidad de la información.

27. ¿Cuál de los siguientes es un ejemplo de un sistema de información de gestión empresarial?

* [ ] a) Sistema de nómina.
* ☑️ b) Sistema ERP (Enterprise Resource Planning).
...
* ☑️ c) Capacitar a los empleados en GRC.
...
* ☑️ c) Al procesar grandes conjuntos de datos para proporcionar información en tiempo real para la toma de decisiones.
...
* ☑️ c) Las empresas se enfrentan a riesgos y complejidades sin precedentes, lo que hace que los marcos de GRC sean más importantes que nunca.
